...
`implement`, `plan`, `review-loop`, `tidy-up-agents-md`,
`use-simplified-english`, plus `shared/delegation.md`. Scenario-test **only**
these. Do not add scenarios for sourced skills.

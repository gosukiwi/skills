...
| [`plan`](skills/plan/SKILL.md) | Scope a GitHub issue to one PR: rewrite the slice spec, peel leftover work onto one bookmark issue. | [gosukiwi/skills](https://github.com/gosukiwi/skills/blob/main/skills/plan/SKILL.md) |

...
| [`plan`](skills/plan/SKILL.md) | Scope one PR from a GitHub issue or from this session: file a slice spec, peel leftover work onto a new issue, close the original when it was a GitHub issue. | [gosukiwi/skills](https://github.com/gosukiwi/skills/blob/main/skills/plan/SKILL.md) |
